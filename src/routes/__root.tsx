...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hedma هدمة - متجر ملابس عصري بأحدث الموديلات. تيشيرتات، بناطيل، كوتشيات، إكسسوارات. جرّب اللبس بالذكاء الاصطناعي قبل ما تشتري." },
      { property: "og:title", content: "Hedma | هدمة" },
      { property: "og:description", content: "أناقة عصرية بلمسة ذهبية." },
